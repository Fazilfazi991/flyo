export const packages = [
  {
    ...
    highlights: [
      { number: "01", title: "Thrill of Dune Bashing", text: "Feel the rush as our expert drivers take you across rolling dunes in a powerful 4x4. An experience you’ll never forget.", image: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?auto=format&fit=crop&w=900&q=85" },
      { number: "02", title: "Arabian Camp Experience", text: "Step into a traditional Bedouin-style camp and enjoy warm Arabian hospitality with dates, Arabic coffee & more.", image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=900&q=85" },
      { number: "03", title: "Sunset & BBQ Dinner", text: "Watch the desert turn magical at sunset and indulge in a delicious BBQ dinner with vegetarian & non-veg options.", image: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=900&q=85" },
      { number: "04", title: "Live Entertainment", text: "Enjoy mesmerizing performances including Tanoura, Belly Dance & Fire Show under the stars.", image: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&w=900&q=85" }
    ],
    timeline: [

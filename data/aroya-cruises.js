export const commonCruiseInclusions = [
...
export const commonCruiseExclusions = [
  "Airfare",
...
export const commonCruiseImportantInfo = [
...
export const cruiseVisaNote = "Visa requirements depend on nationality, residency status, and cruise route. Please contact our team before booking so we can guide you with the correct visa information.";

export const aroyaCruises = [
  {
    slug: "aroya-dubai-arabian-escape",
    title: "Aroya Dubai Arabian Escape",
    url: "/packages/aroya-dubai-arabian-escape.html",
    image: "https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&w=1600&q=88",
    durationBadge: "7N / 8D",
    duration: "7 Nights / 8 Days",
    price: "AED 2590",
    departure: "Feb 2027 - 06",
    overview: "A 7-night Arabian Gulf cruise round-trip from Dubai with a mix of relaxation, culture, scenic coastlines, and city experiences. The journey includes Dubai, a day at sea, Muscat, Khasab, Abu Dhabi, Sir Bani Yas Island, and return to Dubai.",
    itinerary: [
      { day: "Day 1", title: "Dubai", text: "Begin the journey in Dubai, board the cruise, explore onboard facilities, enjoy dining and entertainment, and set sail late evening." },
    ...
    timings: [
      "Day 1: Dubai | Depart 11:59 PM",
      "Day 2: At Sea",
      "Day 3: Muscat | 07:00 AM to 07:00 PM",
      "Day 4: Khasab",
      "Day 5: Abu Dhabi | Arrive 08:00 AM",
      "Day 6: Abu Dhabi | Depart 02:00 AM",
      "Day 7: Sir Bani Yas | 08:00 AM to 06:00 PM",
      "Day 8: Dubai | Arrive 08:00 AM"
    ]
  },
  {
    ...
    duration: "7 Nights / 8 Days",
    price: "AED 2590",
    departure: "Feb 2027 - 27",
    overview: "A 7-night Arabian Gulf cruise round-trip from Dubai combining culture, modern cities, natural beauty, and relaxation. The journey includes Khasab, Abu Dhabi, Sir Bani Yas, Doha, Bahrain, a day at sea, and return to Dubai.",
    itinerary: [
    ...
    timings: [
      "Day 1: Dubai | Depart 11:59 PM",
      "Day 2: Khasab | 09:00 AM to 08:00 PM",
      "Day 3: Abu Dhabi | 08:00 AM to 11:00 PM",
      "Day 4: Sir Bani Yas | 08:00 AM to 06:00 PM",
      "Day 5: Doha | 08:00 AM to 08:00 PM",
      "Day 6: Bahrain | 10:00 AM to 08:00 PM",
      "Day 7: At Sea",
      "Day 8: Dubai | Arrive 08:00 AM"
    ]
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1566552881560-0be862a7c445?auto=format&fit=crop&w=1600&q=88",
    durationBadge: "2N / 3D",
    duration: "2 Nights / 3 Days",
    price: "AED 791",
    departure: "Feb 2027 - 27 | Mar 2027 - 06, 13, 20, 27 | Apr 2027 - 03",
    overview: "A short 2-night Arabian Gulf cruise from Dubai to Abu Dhabi aboard Aroya Cruises. The journey combines scenic coastal views, relaxation, Khasab's fjord-like landscapes, and Abu Dhabi's cultural and modern attractions.",
    itinerary: [
    ...
    timings: [
      "Day 1: Dubai | Depart 10:00 PM",
      "Day 2: Khasab | 09:00 AM to 08:00 PM",
      "Day 3: Abu Dhabi | Arrive 08:00 AM"
    ]
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1599640842225-85d111c60e6b?auto=format&fit=crop&w=1600&q=88",
    durationBadge: "7N / 8D",
    duration: "7 Nights / 8 Days",
    price: "AED 2474",
    departure: "Apr 2027 - 10",
    overview: "A relaxing 7-night voyage aboard AROYA Cruises from Dubai to Jeddah, featuring scenic days at sea and stops in Muscat and Salalah. Guests can enjoy Arabian hospitality, coastal beauty, onboard entertainment, and cultural experiences.",
    itinerary: [
    ...
    timings: [
      ...
      "Day 3: Muscat | 07:00 AM to 07:00 PM",
      "Day 4: At Sea",
      "Day 5: Salalah | 07:00 AM to 02:00 PM",
      "Day 6: At Sea",
      "Day 7: At Sea",
      "Day 8: Jeddah | Arrive 07:00 AM"
    ]
  }
].map(item => ({
  ...item,
  whatsappMessage: `Hi, I'm interested in ${item.title}. Please share more details.`,
  optionalToursNote: "Guests can explore destinations independently or book cruise line excursions at an additional charge.",
  visaNote: cruiseVisaNote,
